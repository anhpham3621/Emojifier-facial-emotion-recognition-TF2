...
# Replace TensorFlow 1 placeholders and session-based execution with TF 2 eager execution and models
...
def inference(model, gray_img_input):
...
if __name__ == '__main__':
    ...
    model = tf.keras.models.load_model(os.path.join(CHECKPOINT_SAVE_PATH, 'model.h5'))
